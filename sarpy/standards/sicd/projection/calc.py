...
def compute_coa_pos_vel(
    ...
    tx_coa = t_coa - r_x0 / sarpy.constants.speed_of_light
    ...
    tr_coa = t_coa + r_r0 / sarpy.constants.speed_of_light
...
def r_rdot_to_constant_hae_surface(
    ...
    *,
    ...
    for _ in range(nlim):
        ...
        gpp_llh = sarpy.standards.geocoords.ecf_to_geodetic(gpp[above_threshold, :])
    ...
    slp_llh = sarpy.standards.geocoords.ecf_to_geodetic(slp)
    ...
    spp_tgt = sarpy.standards.geocoords.geodetic_to_ecf(spp_llh)
