...
import sarpy.standards.sicd.io as sicdio
...
SCHEMA_DIR = importlib.resources.files("sarpy.standards.sidd.schemas")
...
class SiddNitfReader:
    ...
    def __init__(self, file):
        ...
        self._nitf_details = sarpy.standards.general.nitf.NITFDetails(self._file)
...
class SiddNitfWriter:
    ...
    def __init__(self, file, nitf_plan):
        ...
        for idx, imhdr in enumerate(imhdrs):
            ...
            xml_helper = sarpy.standards.sidd.xml.XmlHelper(imageinfo.sidd_xmltree)
        ...
        for imageinfo in self._nitf_plan.images:
            ...
            des_managers.append(
                sarpy.standards.general.nitf.DESSubheaderManager(
        ...
        writing_details = sarpy.standards.general.nitf.NITFWritingDetails(
            header,
