...
.. autoprogram:: sarpy.verification.sicd_consistency:_parser()
...
import sarpy.standards.sicd as ss_std
...
from sarpy.standards import geocoords
from sarpy.standards.general.nitf import NITFDetails
...
def _compute_pfa_min_max_fx(xmlhelp):
    ...
    def _k_rect_to_fx(krg, kaz):
        ...
        return sarpy.constants.c / 2.0 / npp.polyval(theta, ksf) * kap
